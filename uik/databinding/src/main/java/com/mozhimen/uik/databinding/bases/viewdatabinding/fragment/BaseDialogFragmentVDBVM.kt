 ...
 * @Version 1.0
 */
abstract class BaseDialogFragmentVDBVM<VB : ViewDataBinding, VM : BaseViewModel> : com.mozhimen.uik.databinding.bases.viewdatabinding.fragment.BaseDialogFragmentVDB<VB>, IActivity,
